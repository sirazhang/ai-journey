...
| 项目 | 大小 | 说明 |
|------|------|------|
| **前端部署** | **~441 MB** | 仅 dist 文件夹 (已优化) |
| **后端部署** | **~24 KB** | backend 文件夹 + package.json |
| **总部署大小** | **~441 MB** | 不包含 .git 和 node_modules |

> 💡 **重要**: 部署时不需要 .git (1.3 GB) 和 node_modules (152 MB)，实际部署大小仅为 **441 MB**
> 
> 🎉 **优化成果**: 通过 Island (-16 MB) 和 Glacier (-5 MB) 优化，从 463 MB 减少到 441 MB
...
| 文件夹 | 大小 | 占比 | 主要内容 | 变化 |
|--------|------|------|----------|------|
| **glacier/** | 153 MB | 34.7% | 冰川场景资源 | ⬇️ -5 MB |
| **background/** | 72 MB | 16.3% | 背景 GIF 动画 | - |
| **island/** | 60 MB | 13.6% | 岛屿场景资源 | ⬇️ -16 MB |
| **sound/** | 46 MB | 10.4% | 音效和背景音乐 | - |
| **desert/** | 46 MB | 10.4% | 沙漠场景资源 | - |
| **jungle/** | 39 MB | 8.8% | 丛林场景资源 | - |
| **npc/** | 20 MB | 4.5% | NPC 角色资源 | - |
| **city/** | 3.5 MB | 0.8% | 城市场景资源 | - |
| **icon/** | 316 KB | 0.1% | UI 图标 | - |
| **总计** | **441 MB** | 100% | | **⬇️ -22 MB** |
